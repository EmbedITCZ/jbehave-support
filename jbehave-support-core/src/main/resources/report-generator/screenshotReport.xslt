<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="stepScreenshots">
        <xsl:param name="storyIndex"/>
        <xsl:for-each select="stepScreenshots">
            <p>
                <div class="card">
                    ...
                    <div id="step-screen-shots" class="card-body collapse show">
                        <xsl:choose>
                            <xsl:when test="stepScreenshot">
                                <xsl:call-template name="stepScreenshot"/>
                            </xsl:when>
    ...
    <xsl:template name="stepScreenshot">
        <xsl:for-each select="stepScreenshot">
